# Enabling Collision
Attach a [Collider 2D](https://docs.unity3d.com/6000.5/Documentation/Manual/Collider2D.html) component to your Sprite Shape to enable the Collider properties in the __Sprite Shape Controller__. However, note that only the [Edge](https://docs.unity3d.com/6000.5/Documentation/Manual/class-EdgeCollider2D.html) and [Polygon Collider 2D](https://docs.unity3d.com/6000.5/Documentation/Manual/class-PolygonCollider2D.html) components can be used with __Sprite Shapes__.
