...
namespace UnityEditor.Tilemaps
{
    internal static class DefaultAssetCreation
    {
        ...
        private static void DuplicateWhiteboxSample(Sample sample)
        {
            ...
            action.path = path;
            StartNewAssetNameEditingDelegate(EntityId.None, action, destName, icon, "");
        }
        ...
        internal class DuplicateWhiteboxPaletteEndNameEditAction : ProjectWindowCallback.AssetCreationEndAction
        {
            public string path;
