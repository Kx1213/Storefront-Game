...
internal class NativeArrayTests : CollectionsTestFixture
{
    ...
    public unsafe void NativeArray_IndexOf_Int()
    {
        ...
        Assert.False(r0);
        Assert.False(-1 != NativeArrayExtensions.IndexOf(container.AsReadOnlySpan(), 456));

        Assert.True(r1);
        Assert.True(NativeArrayExtensions.Contains(container.AsReadOnlySpan(), 123));

        Assert.True(r2);
        Assert.True(NativeArrayExtensions.Contains(container.AsReadOnlySpan(), 789));
    ...
    public unsafe void NativeArray_IndexOf_FixedString128()
    {
        ...
        Assert.False(r0);
        Assert.False(-1 != NativeArrayExtensions.IndexOf(container.AsReadOnlySpan(), new FixedString128Bytes("456")));

        Assert.True(r1);
        Assert.True(NativeArrayExtensions.Contains(container.AsReadOnlySpan(), new FixedString128Bytes("123")));

        Assert.True(r2);
        Assert.True(NativeArrayExtensions.Contains(container.AsReadOnlySpan(), new FixedString128Bytes("789")));
