...
![The Has Variable node checks whether the score variable exists. It triggers Get Variable if the variable exists, and prints a message to the console if the variable doesn't exist.](images/vs-variables-has-variable-node.png)
...
![The Graph Inspector window with a selected Fallback option, and the Get Variable node showing the Fallback.](images/vs-variables-get-variable-fallback-option.png)
...
![The kind dropdown on a Get Variable node](images/vs-variables-change-scope-node.png)
