...
namespace UnityEditor.Tilemaps
{
    ...
    internal class GridPaintActiveTargetsPreferences
    {
        ...
        public static readonly string defaultCreateTileMode = L10n.Tr("TileUtility.DefaultTile");
        ...
        internal static void PreferencesGUI()
        {
            using (new SettingsWindow.GUIScope())
            {
                ...
                {
                    var createTileFullName = EditorPrefs.GetString(createTileFromPaletteEditorPref, defaultCreateTileMode);
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    var createTileFullName = defaultCreateTileMode;
        ...
        {
            var createTileFullName = EditorPrefs.GetString(createTileFromPaletteEditorPref, defaultCreateTileMode);
            if (!createTileFullName.Equals(defaultCreateTileMode))
            {
